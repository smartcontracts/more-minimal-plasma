...
contract RootChain {
    ...
    function deposit() public payable {
        ...
        currentPlasmaBlockNumber = currentPlasmaBlockNumber++;
    }
    ...
    function challengeExit(
        ...
        bool isConfirmed = (owner == ECRecovery.recover(confirmationHash, _spendingTxConfirmationSignature));
        bool isExiting = (plasmaExits[exitingUtxoPosition].isStarted);
        require(isConfirmed || isExiting, "Transaction must be confirmed or exiting.");
